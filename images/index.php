        ...
        <div class="main-body container-fluid">
            ...
            <div class="row1">
                <div class="card" style="width: 18rem;">
                    <img src="https://www.notebookcheck.net/uploads/tx_nbc2/2-103-e1587727512700_01.jpg" class="card-img-top" alt="Vivobook laptop">
                    <div class="card-body">
                      <h5 class="card-title">Asus Vivobook</h5>
                      <p class="card-text">i5 512gb 8gb RAM</p>
                      <a href="#" class="btn  col-12">Buy</a>
                    </div>
                  </div>
                  <div class="card" style="width: 18rem;">
                    <img src="https://www.notebookcheck.net/uploads/tx_nbc2/2-103-e1587727512700_01.jpg" class="card-img-top" alt="Vivobook laptop">
    ...
    <div class="footer">
      <footer class="page-footer font-small stylish-color-dark pt-4">
        ...
        <div class="footer-copyright text-center py-3">
          © 2022 Copyright:
          <a href="index.html">LaptopShop</a>
        </div>
      </footer>
    </div>
</body>
